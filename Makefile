...
DRIVER3_NAME = driver-protobuf-c-tcp-event
DRIVER3_OBJECTS = examples/$(DRIVER3_NAME).o ksocket/ksocket.o ksocket/berkeley.o ksocket/event.o protobuf-c/protobuf-c.o examples/example.pb-c.o
DRIVER3_TARGET = $(DRIVER3_NAME).sys
LDFLAGS_$(DRIVER3_TARGET) = ksocket/Uuid.Lib
